...
</p> <div class="flex flex-wrap gap-3"> ${renderComponent($$result2, "CTAButton", $$CTAButton, { "href": "/contact/", "label": "Demander un devis" }, { "default": ($$result3) => renderTemplate`Demander un devis` })} ${renderComponent($$result2, "CTAButton", $$CTAButton, { "href": "/realisations/", "variant": "secondary", "label": "Voir les r\xE9alisations" }, { "default": ($$result3) => renderTemplate`
...
Voir le projet →
</a> </article>`)} </div> </section> <section class="border-t border-black/10 bg-black/5"> <div class="mx-auto grid max-w-6xl gap-10 px-6 py-16 lg:grid-cols-[1.1fr,0.9fr]"> <div> <h2 class="text-3xl font-semibold text-ink">Questions fréquentes</h2> <p class="mt-3 text-black/70">
