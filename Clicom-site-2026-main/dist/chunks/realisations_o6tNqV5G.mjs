const realisations = [
  {
    ...
    solution: "Création d'un site rapide avec CTA visibles, menu structuré et formulaire simplifié.",
  ...
  },
  {
    ...
    solution: "Landing page orientée bénéfices, preuves sociales et capture de leads.",
  ...
  },
  {
    ...
    solution: "Optimisation Google Business Profile et production de contenus ciblés.",
  ...
  },
  {
    ...
    solution: "Refonte de la navigation, pages rapides, formulaires courts.",
  ...
  },
  {
    ...
    solution: "Automations simples reliées au formulaire et pipeline léger.",
  ...
  },
  {
    ...
    solution: "Audit des campagnes, nouvelles annonces et landing dédiée.",
